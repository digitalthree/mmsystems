        ...
        >
          ...
          <span className=" xl:text-7xl text-5xl font-normal text-white">
            ...
            <div className=" w-full bg-[#e4e4e4] p-10 py-20">
                <div
                    className=" container flex flex-col justify-center mx-auto bg-[url(/img/chisiamo/brain.webp)] bg-no-repeat bg-scroll bg-contain bg-right">
              ...
              tecnologica. <br/> Infatti, MM Systems diviene portavoce e precursore di
