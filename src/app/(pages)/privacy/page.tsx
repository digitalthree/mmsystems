  ...
  return (
    <>
      <Seo
        ...
        description="Privacy e cockie policy" 
        index={false}
      />
      <div className="container mx-auto py-20 gap-10 flex flex-col justify-start items-start">
        <div className="flex flex-col gap-4">
          <h2>Titolare del Trattamento dei Dati</h2>
          <p>
            MM Systems – Contrada Castel di sette – 66030 Mozzagrogna (Ch) –
            Italia
          </p>
          <p>
            <b>Indirizzo email del Titolare:</b> mmsystemsplatform@gmail.com
          </p>
        </div>
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            autonomo o tramite terze parti, ci sono: Cookie; Dati di utilizzo.
          </p>
          <p>
            ...
            diversamente specificato, tutti i Dati richiesti da questa
            ...
            Servizio. Nei casi in cui questa Applicazione indichi alcuni Dati
            come facoltativi, gli Utenti sono liberi di astenersi dal comunicare
            tali Dati, senza che ciò abbia alcuna conseguenza sulla
            disponibilità del Servizio o sulla sua operatività. Gli Utenti che
            dovessero avere dubbi su quali Dati siano obbligatori, sono
            incoraggiati a contattare il Titolare. L’eventuale utilizzo di
            Cookie – o di altri strumenti di tracciamento – da parte di questa
            Applicazione o dei titolari dei servizi terzi utilizzati da questa
            Applicazione, ove non diversamente precisato, ha la finalità di
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            l Titolare adotta le opportune misure di sicurezza volte ad impedire
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="pl-10 list-disc flex flex-col gap-4">
            ...
            <li>
              l trattamento è necessario per adempiere un obbligo legale al
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            Statistica, Visualizzazione di contenuti da piattaforme esterne e
            Servizi di piattaforma e hosting.
          </p>
          <p>
            Per ottenere informazioni dettagliate sulle finalità del trattamento
            e sui Dati Personali trattati per ciascuna finalità, l’Utente può
            fare riferimento alla sezione “Informazioni dettagliate sul
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            questa Applicazione nonché, qualora tecnicamente e legalmente
            fattibile, inviando una notifica agli Utenti attraverso uno degli
            estremi di contatto di cui è in possesso. Si prega dunque di
