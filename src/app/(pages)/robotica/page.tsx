...
import robotBlu from "../../../../public/img/attivita/robotica/robot-blu.webp";
...
export default function Page() {
  ...
  return (
    <>
      <div className="w-full robotica bg-cover bg-center flex justify-center">
        <div className="w-full bg-slate-50/[.85] min-h-[85vh] flex flex-col justify-center items-center">
      ...
      <div>
        <section className="w-full relative">
          ...
          />
          <div className="container p-8 mx-auto grid grid-cols-1 md:grid-cols-2 mt-8 items-center">
            ...
            <div className="flex flex-col md:pl-16 z-10">
              <div className="flex flex-col mb-8">
                <h4 className=" text-primary text-2xl font-semibold">
                  INVENTIAMO
                </h4>
                <div className="divider divider-primary mt-1 mb-0"></div>
        ...
        <div className="container p-8 text-center mx-auto text-[#3f3f3f]">
          ...
          <h3 className=" font-semibold text-2xl mt-3">
            SULLE ISOLE ROBOTIZZATE
          </h3>
        </div>
        <div className="w-full bg-black text-white flex items-center justify-center h-64">
          VIDEO DA AGGIUNGERE
        </div>
        <section className="w-full relative py-8 lg:py-20">
          <Image
          ...
          />
          <div className="container mx-auto p-8 xl:p-0 flex flex-col md:flex-row justify-center items-center text-[#3f3f3f] z-10">
